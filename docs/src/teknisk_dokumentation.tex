...
Communicator tar emot begäran från mjukvaruklienten och innehåller all logik för att leverera korrekt svar.
TODO:Team Bluetooth kanske vill knyta an det här till det de skriver om Bluetooth

\paragraph{Position}
Position innerhåller alla rutiner för hur roboten bestämmer sin position på kartan beroende på vilket tillstånd i kartläggningen roboten befinner sig. Se~\ref{sec:position} för en utförligare beskrivning av hur positionsbestämningen fungerar. 
