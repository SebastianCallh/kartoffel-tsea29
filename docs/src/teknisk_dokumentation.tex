...
För att kommunicera med roboten används en mjukvaruklient. Programmet är skrivet i Python och 

\subsubsection{Presentationsenhet}
TODO: Innehåll här. Programflöde.
TODO: Eventuellt inte en rubrik. Innehåll här med

\subsubsection{Fjärrstyrningsenhet}
