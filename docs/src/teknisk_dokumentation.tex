...
I tabell~\ref{table:sensor-components} listas komponenterna i sensorenheten.
\subsubsection{Resurser}
...
\end{tabular}
\end{table}
I tabell~\ref{table:sensor-resurser} listas antalet portar som behövs på ATmegan.
