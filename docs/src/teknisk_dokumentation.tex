...
\clearpage
\section{Inledning}
Systemet beskrivet i det här dokumentet är en kartläggningsrobot som dels kan fjärrstyras och dels släppas in i ett rum och autonomnt söka av det för att sedan återvända till ingången.
\subsection{Bakgrund}
