...
% Se kommentarer för huvudenhet
Styrenhetens uppgift är att kontrollera alla robotens fysiska rörelser. Styrenheten kommer att ta emot kommandon från huvudenheten som sedan översätts till signaler som skickas ut till styrenhetens servon. Det är genom styrenhetens funktionalitet  som roboten kommer att kunna förflytta sig igenom rummet som ska kartläggas.
 
\subsubsection{Delsystemets funktion}
Styrenheten kommer att bestå av en ATMega 1284 processor som kommer att ha servon kopplade till sig. Ifrån huvudenheten kommer kommandon som processorn omvandlar och skickar vidare till servona. Kommandona från huvudenheten kommer 
