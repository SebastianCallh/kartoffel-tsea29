...
Ett övergripande blockschema av systemet visas i figur ~\ref{fig:oversikt_systemet3}.
...
\begin{figure}[H]
\centering
\includegraphics[scale=0.6]{Huvudenhet_kopplingsschema}
