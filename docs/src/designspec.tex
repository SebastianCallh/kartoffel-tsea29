...
\begin{figure}[H]
%\centering
\includegraphics[scale=0.4]{Oversikt_presentationsenhet3}
\caption{Presentationsenheten i omgivning}
...
\begin{figure}[H]
\centering 
\includegraphics[scale=0.4]{Oversikt_fjarrstyrenhet3}
...
Bluetooth-kommunikationen kommer ske över samma protokoll som används för kommunikationen över huvudbussen. Detta dels för att kunna återanvända samma lösning, vilket förenklar utvecklingsprocessen, dels för att förenkla hanteringen av kommunikationen i huvudenheten. Genom att använda samma protokoll för kommunikation över Bluetooth som för huvudbussen kan kommunikationen hanteras på ett och samma ställe inom huvudenheten, istället för att behöva dela upp kommunikationshanteringen.
