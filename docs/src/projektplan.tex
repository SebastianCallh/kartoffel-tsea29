...
\begin{center}
  \resizebox{\textwidth}{!}{\begin{tabular}{ | l | l | l | }
    ...
    5 & Positionsbestämning kan ske utifrån data från accelerometer, gyro samt lasersensor & 2016-12-06 \\ \hline
    6 & Roboten är tävlingsklar (avancerad variant) & 2016-12-09 \\ \hline
  \end{tabular}}
\end{center}
