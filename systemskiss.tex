...
\caption{Figur X - Översiktsblockschema över styrenheten}
\end{figure}
Styrenheten är över gränssnittet I2C kopplad till huvudenheten.\newline\newline
Styrenheten har en processor av typ ATmega1284.\newline\newline
Styrenheten har fyra hjulservon indelade i två hjulpar som kan styras individuellt. Dessa kontrollerar robotens position och kommunicerar med processorn med PWM och en riktningssignal.\newline\newline
