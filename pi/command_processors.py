...
def process_sensor_data(left_ir_mm_hi, left_ir_mm_lo,
                        ...
                        left_ir_back_mm_hi, left_ir_back_mm_lo, *args):
    left_ir_mm = twos_comp((left_ir_mm_hi << 8) | left_ir_mm_lo, 16)
    right_ir_mm = twos_comp((right_ir_mm_hi << 8) | right_ir_mm_lo, 16)
    right_ir_back_mm = twos_comp((right_ir_back_mm_hi << 8) | right_ir_back_mm_lo, 16)
    left_ir_back_mm = twos_comp((left_ir_back_mm_hi << 8) | left_ir_back_mm_lo, 16)

    return [left_ir_mm, right_ir_mm, right_ir_back_mm, left_ir_back_mm] + list(args)
