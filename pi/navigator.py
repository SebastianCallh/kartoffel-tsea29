...
class auto_control(State):
	...
	def sensor_data_received(self, new_ir_right, new_ir_left):
		...
		driver.drive(left_speed, right_speed, 500)
...
class Navigator:
	...
	def sensor_data_received(self, new_ir_right, new_ir_left):
		self.state.sensor_data_received(new_ir_left, new_ir_right)
		data['old_ir_left'] = data['ir_left']
		data['old_ir_right'] = data['ir_right']
