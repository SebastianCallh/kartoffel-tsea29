...
\begin{center}
  \begin{tabular}{ | l | l | l | }
    ...
    5 & Ett enkelt interface ska ha utvecklats mellan huvud- och styrmodul för att kunna fjärrstyra något / några servon & 2016-11-18 \\
		6 & Sensorenheten ska kunna skicka sensordata till huvudmodulen och vidare via Bluetooth till den bärbara datorn & 2016-11-18 
    7 & Huvudmodulen ska kunna tolka sensordata och göra om denna till kartdata som presentationsenheten kan tolka & 2016-11-xx
		9 & Huvudmodulen ska kunna upptäcka "okända områden" med hjälp av sensordata & 2016-11-xx
		8 & Presentationsenheten ska kunna tolka och representera kartdatan för att rita upp en grafisk karta & 2016-11-xx
		9 & Roboten ska i sitt autonoma läge, självmant styra mot de "okända områdena" & 2016-12-xx
		10 & Roboten ska i sitt autonoma läge ta sig tillbaks till "garaget" när det ej finns några "okända områden" kvar & 2016-12-xx
